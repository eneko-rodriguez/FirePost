package net.azarquiel.imgpicker.picker
...
import net.azarquiel.myapplication.activities.MainActivity
...
class Picker(var activity: Activity ) {
    ...
    private fun checkPermiss() {
        if (    ContextCompat.checkSelfPermission(activity, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED
            ...
            ActivityCompat.requestPermissions(activity,
                ...
                ActivityPost.REQUEST_PERMISSION
            )
        }
    }
    ...
    fun showPictureDialog() {
     ...
     fun photoFromGallery() {
        ...
        activity.startActivityForResult(galleryIntent, ActivityPost.REQUEST_GALLERY)
    }
     ...
     fun photoFromCamera() {
        ...
        if (intent.resolveActivity(activity.packageManager) != null) {
            ...
            photoFile?.let {
                ...
                activity.startActivityForResult(intent, ActivityPost.REQUEST_CAMERA)
    ...
    fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>, grantResults: IntArray) {
        if (requestCode == ActivityPost.REQUEST_PERMISSION && grantResults.isNotEmpty()) {
